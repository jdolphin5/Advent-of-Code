...
const computeAntinodePositions = (
    ...
    for (let i = 0; i < value.length; i++) {
        for (let j = i + 1; j < value.length; j++) {
            ...
            let antinode1I: number = coord1.x;
            let antinode1J: number = coord1.y;

            let antinode2I: number = coord2.x;
            let antinode2J: number = coord2.y;
            ...
            while (
                ...
                antinode1I += coord1.x - coord2.x;
                antinode1J += coord1.y - coord2.y;
            }
            while (
                ...
                antinode2I += coord2.x - coord1.x;
                antinode2J += coord2.y - coord1.y;
            }
        }
    }
};
